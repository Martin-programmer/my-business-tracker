  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 mt-8">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        <h4 className="font-bold text-gray-700 mb-2">🔧 Административни инструменти</h4>
        <form action={async () => {
            // Тъй като не можем да импортнем сървърна функция директно тук лесно без да променяме файла на 'use server',
            // ще направим малък трик в следващата стъпка.
            // ЗА СЕГА ПРОСТО СЛОЖИ БУТОНА, ЩЕ ГО СВЪРЖЕМ СЛЕД МАЛКО
        }}>
           <p className="text-sm text-gray-500 mb-2">Натисни, за да изтеглиш разходите за ВЧЕРА от Facebook.</p>
           {/* Ще го направим отделен компонент за по-лесно */}
        </form>
      </div>
    </div>
  )
